...
insert into NIVEAU_QUESTION(rank_niveau,nom_niveau) value 
	("1","Facile"),
	("2","Moyenne"),
	("3","difficile"),
	("4","extreme");
insert into Question(id_categorie,id_niveau,question) value 
...
insert into REPONSE(id_question,reponse,ifvrai) value 
	(1,"oui","1"), 
	(1,"non","0"), 
	(1,"peut-etre","0"),
	(1,"je ne sais pas","0"),
